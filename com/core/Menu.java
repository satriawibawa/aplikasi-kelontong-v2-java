...
public class Menu{
  ...
  public static void menuTampilNama(){
    ...
    System.out.println("**DATA BARANG KELONTONG**");
    System.out.println("Menu 2.3 (Menampilkan Data Berdasarkan Nama) :");
    System.out.println("1. Semua ");
  ...
  public static void menuTampilNamaTertentu(){
    ...
    System.out.println("**DATA BARANG KELONTONG**");
    System.out.println("Menu 2.3.2 (Menampilkan Data Berdasarkan Nama Tertentu) :");
  ...
  public static void menuTampilDist(){
    ...
    System.out.println("**DATA BARANG KELONTONG**");
    System.out.println("Menu 2.4 (Menampilkan Data Berdasarkan Distributor) :");
    System.out.println("1. Semua ");
  ...
  public static void menuTampilDistTertentu(){
    ...
    System.out.println("**DATA BARANG KELONTONG**");
    System.out.println("Menu 2.4.2 (Menampilkan Data Berdasarkan Distributor Tertentu) :");
  ...
  public static void menuTampilHarga(){
    ...
    System.out.println("**DATA BARANG KELONTONG**");
    System.out.println("Menu 2.5 (Menampilkan Data Berdasarkan Harga) :");
    System.out.println("1. Semua ");
  ...
  public static void menuTampilHargaTertentu(){
    ...
    System.out.println("**DATA BARANG KELONTONG**");
    System.out.println("Menu 2.5.2 (Menampilkan Data Berdasarkan Harga Tertentu) :");
